      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-pastel-aqua-800 to-pastel-rose-400 rounded-3xl p-12 text-white text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a
              href="https://subito.it/annunci-italia/vendita/abbigliamento-accessori/?q=filamentincantati"
              target="_blank"
            ...
            >
              ...
              Acquista su Subito.it
            </a>
            
            <div className="text-white/80">oppure</div>
            
            <a
              href="https://wa.me/393295381974?text=Ciao! Sono interessato/a ai gioielli Filamentincantati"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center px-8 py-4 border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-pastel-aqua-800 transition-all duration-300 min-w-[250px]"
            >
